...
(function () {
  ...
  function openDashboard() {
    const popup = window.open("", "card-offers-dashboard");
    if (!popup) {
      notice = "Allow pop-ups to open the local dashboard";
      render();
      return false;
    }
    popup.document.open();
  ...
  function mountDashboard(targetDocument = document) {
    dashboard = targetDocument.createElement("main");
