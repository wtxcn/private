...
const configs = [
  ...
  { file: 'USBankOffersAssistant.user.js', adapter: 'usbank', factory: 'createUSBankAdapter', id: 'usbank-offers-assistant', name: 'U.S. Bank Offers Assistant', version: '0.1.0', namespace: 'https://onlinebanking.usbank.com/', match: 'https://onlinebanking.usbank.com/digital/*', accent: '#b42339', legacyStore: 'usBankOfferClickerState.v1', cardMode: false, scopePlural: 'collections', allLabel: 'All deals', scanLabel: 'Scan deals' }
];
