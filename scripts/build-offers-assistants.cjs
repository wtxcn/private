...
const configs = [
  { file: 'CitiOffersAssistant.user.js', adapter: 'citi', factory: 'createCitiAdapter', id: 'citi-offers-assistant', name: 'Citi Offers Assistant', version: '0.1.7', namespace: 'https://online.citi.com/', match: 'https://online.citi.com/US/nga/products-offers/merchantoffers*', accent: '#0874cf', legacyStore: 'citiOfferClickerState.v1', legacyPanel: 'citi-offer-clicker', cardMode: true, scopePlural: 'cards', allLabel: 'All cards', scanLabel: 'Scan all cards' },
  { file: 'USBankOffersAssistant.user.js', adapter: 'usbank', factory: 'createUSBankAdapter', id: 'usbank-offers-assistant', name: 'U.S. Bank Offers Assistant', version: '0.1.9', namespace: 'https://onlinebanking.usbank.com/', match: 'https://onlinebanking.usbank.com/digital/*', accent: '#b42339', legacyStore: 'usBankOfferClickerState.v1', legacyPanel: 'usbank-offer-clicker', cardMode: false, scopePlural: 'cards', allLabel: 'All cards', scanLabel: 'Scan deals' }
];
